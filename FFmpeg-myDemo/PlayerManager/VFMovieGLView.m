...
@protocol VFMovieGLRenderer
- (BOOL) isValid;
- (NSString *) fragmentShader;
- (void) resolveUniforms: (GLuint) program;
- (void) setFrame: (VFVideoFrame *) frame;
- (BOOL) prepareRender;
@end

@interface VFMovieGLRenderer_RGB : NSObject<VFMovieGLRenderer> {
...
@implementation VFMovieGLRenderer_RGB
...
@interface VFMovieGLRenderer_YUV : NSObject<VFMovieGLRenderer> {
...
@implementation VFMovieGLRenderer_YUV
...
- (void)setFrame:(VFVideoFrame *)frame
{
    VFVideoFrameYUV *yuvFrame = (VFVideoFrameYUV *)frame;
...
@implementation VFMovieGLView {
    ...
    id<VFMovieGLRenderer> _renderer;
}
             ...
             decoder: (VFMovieDecoder *) decoder
{
    ...
    if (self) {
        ...
        if ([decoder setupVideoFrameFormat:KxVideoFrameFormatYUV]) {
            /// 使用YUV格式渲染
            _renderer = [[VFMovieGLRenderer_YUV alloc] init];
            
        } else {
            /// 使用RGB视频渲染
            _renderer = [[VFMovieGLRenderer_RGB alloc] init];
        }
